    ...
    documentos = [
        {
            ...
            "metadados": {"fonte": "documentacao_fastapi", "categoria": "framework"}
        },
        {
            "texto": (
        ...
        },
        {
            ...
            "metadados": {"fonte": "documentacao_sqlalchemy", "categoria": "database"}
        }
    ]
    ...
    try:
        ...
        for i, texto in enumerate(conhecimento):
            rag_service.add_document_from_text(
                texto,
                {"fonte": f"base_conhecimento_{i}", "tipo": "faq"}
            )
...
def exemplo_busca_conhecimento():
    ...
    docs_tecnicos = [
        {
            ...
            "metadados": {"categoria": "configuracao", "tecnologia": "postgresql"}
        },
        {
            "texto": (
            ...
            "metadados": {"categoria": "configuracao", "tecnologia": "alembic"}
        },
        {
            "texto": (
    ...
    resultados_com_score = rag_service.similarity_search_with_score(consulta, k=3)
