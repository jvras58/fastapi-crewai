...
from apps.api.assignment.router import router as assignment_router
from apps.api.authentication.router import router as auth_router
from apps.api.authorization.middleware import AuthorizationMiddleware
from apps.api.authorization.router import router as authorization_router
from apps.api.role.router import router as role_router
from apps.api.text_processing.router import router as text_processing_router
from apps.api.transaction.router import router as transaction_router
